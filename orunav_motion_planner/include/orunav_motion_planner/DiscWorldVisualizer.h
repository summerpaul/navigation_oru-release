 ...
 * @Last Modified time: 2023-07-20 23:14:46
 */
/**
...
class DiscWorldVisualizer {
 private:
  ...
  /** The number of cells on the x axis on the discretized representation of the
   * World */
  int xTotCels_;
  /** the number of cells on the y axis on the discretized representation of the
   * World */
  int yTotCels_;
  /** Size of the images */
  int imgXsize_;
   ...
   */
  void drawLine(double xfrom, double yfrom, double xto, double yto, int R,
                int G, int B);
   ...
   */
  void drawFilledRectangle(double xfrom, double yfrom, double xto, double yto,
                           int R, int G, int B);
   ...
   * @param R,G,B The color of the rectangle
   */
  void drawRectangle(double xfrom, double yfrom, double xto, double yto, int R,
                     int G, int B);
